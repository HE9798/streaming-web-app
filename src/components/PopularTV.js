...
import { fetchPopularTV } from '../services/ApiConfig'
...
export default function NowPlaying() {
    ...
    const popularTVList = popularTV.map((item, index) => {
        return (
    ...
    return (
        <div className="container">
            ...
            <div className="row mt-5">
                <div className="col">
                    <h2 style={{ fontWeight: 'bold' }}>Popular Series</h2>
                    <hr className="col-md-3 col-sm-6" style={{ color: 'white', height: '3px' }} />                </div>
            </div>

            <div className="row mt-5">{popularTVList}</div>
        </div>
    )
}